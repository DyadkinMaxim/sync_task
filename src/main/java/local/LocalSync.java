...
public class LocalSync implements Sync {
    ...
    public boolean areInSync(File source, File destination) throws IOException {
    ...
    public void synchronize(File source, File destination, boolean smart) throws IOException {
